...
Срез от 20.09.2026 — 4 806 матчей с полными составами, тест 962 матча с 24.08.2026, λ = 5:
...
ΔBrier = **+0,0054** в пользу командной базы, bootstrap-интервал по матчам **[−0,0034; +0,0132]** накрывает ноль. Вывод: на текущих данных знание пятёрки **не улучшает** предматчевую вероятность; различие статистически неотличимо от нуля, точечная оценка против RAPM. Причины видны в том же отчёте: 288 из 962 тестовых наблюдений содержат игрока без коэффициента, а 1 414 игроков полностью неотличимы от партнёров — они появляются ровно в одних и тех же наблюдениях, и L2 делит общий сигнал поровну. Это не опровержение гипотезы, а следствие 11,5% покрытия статистикой и короткой предыстории составов.
